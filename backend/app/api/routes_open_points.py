...
def to_open_point_read(open_point: OpenPoint) -> OpenPointRead:
    ...
    return OpenPointRead(
        ...
        source_type=open_point.source_type,
        refinement_status=open_point.refinement_status,
        raw_source_open_point_ids_json=open_point.raw_source_open_point_ids_json,
